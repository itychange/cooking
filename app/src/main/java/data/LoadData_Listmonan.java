...
public class LoadData_Listmonan extends AsyncTask<Integer, Integer, ArrayList<object>> {
    ...
    public LoadData_Listmonan(ArrayList<object> mArrayList,ListView mListView,String url,Activity context,MaterialProgressBar progressBar,NetworkImageView img_top,TextView txt_top,SwipeRefreshLayout SwipeRefreshLayou,boolean check) {
    ...
    protected void onPreExecute() {
        ...
        adapterImage = new adapter_listmonan(context, mArrayList);
