...
public class List_monan extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new LoadData_Listmonan(mArrayList, lv_monan, intent.getStringExtra("url"), this, materialProgressBar, img_top, txt_top, refreshLayout,false).execute();
    ...
    public void onRefresh() {
        count++;
        if (count < 3) {
            new LoadData_Listmonan(mArrayList, lv_monan, "http://webnauan.net/mon-kho/", this, materialProgressBar, img_top, txt_top, refreshLayout,true).execute();
        } else {
